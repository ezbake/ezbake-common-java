...
public class BinarySerializer implements ThriftSerializer<byte[]> {
    @Override
    public byte[] serialize(TBase<?,?> thriftObject) throws TException {
        return new TSerializer().serialize(thriftObject);
    }
